    ...
    return (
        ...
        <div>
          ...
          <Redirect to='/'/> :
            ...
            <Link to='/'>
                    <IconButton>
                    <ArrowBackIosIcon onClick={logout} />
                    </IconButton>
                </Link>
                </div>
                      ...
                      {userlist.map((val,key)=>{
                          return(
                            <tr>
                                    ...
                                    <td>{val.email}</td>
                                    <td><Link to={{
                                        pathname:'/userproductinfo',
                                        state:{
                                          id:val.id
                                        }
                                    }}  ><button className="button_slide_right"><IconButton><PostAddIcon /></IconButton></button></Link></td>
                                    <td><Link to={{
                                        pathname:'/edituser',
                                        state:{
                                          id:val.id
                                        }
                                    }}  ><button className="button_slide_right"><IconButton><EditAttributesIcon /></IconButton></button></Link></td>
                                    <td> <button className="button_slide_right" onClick={()=>{if(window.confirm('Delete the item?')){deleteUser(val.id);}}}><IconButton><DeleteForeverIcon /></IconButton></button> </td>
                            </tr>
                          )
                      })}
